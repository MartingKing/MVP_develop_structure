...
import com.dhd.cbmxclient.bean.CommentItem;
import com.dhd.cbmxclient.utils.ContextUtils;
import com.dhd.cbmxclient.utils.UrlUtils;
...
public class CommentListView extends LinearLayout {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            //textview的默认颜色
            itemColor = typedArray.getColor(R.styleable.PraiseListView_item_color, getResources().getColor(R.color.color333));
            itemSelectorColor = typedArray.getColor(R.styleable.PraiseListView_item_selector_color, getResources().getColor(R.color.colordc));
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(ContextUtils.getContext(), textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
