...
import com.dhd.cbmxclient.bean.FavortItem;
...
public class PraiseListView extends TextView {
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(ContextUtils.getContext(), R.mipmap.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
