...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.colordc;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = ContextUtils.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = ContextUtils.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
